...
std::vector<PrimaryButton*> PowerCentralWidget::createButtons(const PowerAppletConfig& config,
        ...
        for (size_t i = 0; i != primary_buttons_data.size(); ++i) {
                ...
                PrimaryButton*    power_button = new PowerButton{type,    icon,
                                                                 text,    keys,
                                                                 command, primary_button_properties,
                                                                 this};
